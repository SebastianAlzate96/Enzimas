# -*- coding: utf-8 -*-
"""Datos_estocasticos_Gaussiano_3_estados.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/15TRT80Mv9D9TpBS7QgOMQviedQcGk9yq
"""
...
cov = ([[ 3.62124187e+01,  5.12378636e-01],
 [ 5.12378636e-01,  2.20604730e+00]])
covars = np.tile(cov, (3, 1, 1))

is_pos_def(cov)

markovmodel_P.covars_ = np.array([[[58.46200254,  1.96571072],
        [ 1.96571072, 31.53973326]],

       [[19.82859607, -0.08564975],
        [-0.08564975, 29.84181433]],

       [[30.78884469,  0.84227675],
        [ 0.84227675, 59.51913961]]])
